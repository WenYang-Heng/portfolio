      ...
      <div id='main-container' className='mx-4 md:w-[80%] md:m-auto text-gray max-w-5xl text-lg'>
        ...
        <section ref={addRefs} id='home' className='py-52 grid md:grid-cols-2 gap-8 items-center h-screen animate-fadeinup'>
          <div>
            ...
            <a href='https://drive.google.com/file/d/15STO3XLRm45jiI6nDb4yDItw5AiIslay/view?usp=sharing' target='_blank' className='bg-primary px-4 py-2 rounded-sm text-gray-light'>View CV</a>
          </div>
          <Experience />
        </section>
